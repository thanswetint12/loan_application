...
class _ChatBotUIState extends State<ChatBotUI1> with TickerProviderStateMixin {
  final apiUrl = "http://3.27.83.21:5000/ask";
  ...
  Future<void> askQuestion(String question) async {
    ...
    try {
      ...
      var response = await http.post(
        ...
        body: jsonEncode({
          'user_message': messageController.text, // 👈 ဤနေရာတွင် အသေကိန်းများအစား လူရိုက်လိုက်သည့် စာသားကို တိုက်ရိုက်ပေးပို့လိုက်ပါပြီ
        }),
